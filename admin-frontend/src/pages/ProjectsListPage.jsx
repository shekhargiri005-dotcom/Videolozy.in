            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 text-slate-500">
                        <p>No projects yet.</p>
                        <Link to="/projects/new" className="btn-primary mt-4 inline-flex">Add Your First Project</Link>
                    </div>
                ) : (
                            ...
                            <tbody>
                                {projects.map((p) => (
                                    <tr key={p.id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                        ...
                                        <td className="p-4 text-slate-500">{p.release_date ? new Date(p.release_date).toLocaleDateString() : '—'}</td>
                                        <td className="p-4">{p.is_featured && <Star size={16} className="text-amber-400" fill="currentColor" />}</td>
                                        <td className="p-4">
