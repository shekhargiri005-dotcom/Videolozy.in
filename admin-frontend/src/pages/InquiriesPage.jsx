            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
                <div className="mb-8">
                    ...
                    <p className="text-slate-400 text-sm mt-1">
                        {inquiries.length} total — {inquiries.filter((i) => i.status === 'unread').length} unread
                    </p>
                </div>
                                    ...
                                    <React.Fragment key={i.id}>
                                        ...
                                        >
                                            ...
                                            <td className="p-4 text-slate-400">
                                                <a href={`mailto:${i.email}`} onClick={(e) => e.stopPropagation()} className="hover:text-white transition-colors">{i.email}</a>
                                            </td>
                                            ...
                                            <td className="p-4">
                                                ...
                                                >
                                                    {STATUS_OPTIONS.map((s) => <option key={s} value={s} className="bg-surface-900">{s}</option>)}
                                                </select>
                                            </td>
