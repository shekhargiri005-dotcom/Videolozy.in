...
export default function Navbar({ variant = 'public' }) {
    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-50 ${variant === 'admin' ? 'glass border-b border-white/10' : 'bg-surface-900/70 backdrop-blur-lg border-b border-white/10'}`}>
